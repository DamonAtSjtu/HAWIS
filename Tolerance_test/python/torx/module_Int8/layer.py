...
class crxb_Conv2d(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, ir_drop, device, gmax, gmin, gwire,
                ...
                enable_resistance_variance=False, resistance_variance_gamma=0. ,
                 freq=10e6, temp=300, groups=1, bias=True, crxb_size=64, quantize=8, enable_SAF=False, enable_val_SAF=True,
                 enable_ec_SAF=False):
        ...
        self.w2g = w2g(self.delta_g, Gmin=self.Gmin, G_SA0=self.Gmax,
                       G_SA1=self.Gmin, weight_shape=weight_crxb.shape, enable_SAF=enable_SAF, enable_val_SAF=enable_val_SAF)
        self.Gwire = gwire
        self.Gload = gload
        # DAC
    ...
    def forward(self, input):
        ...
        if self.w2g.enable_SAF or  self.w2g.enable_val_SAF:
...
class crxb_Linear(nn.Linear):
    ...
    def __init__(self, in_features, out_features, ir_drop, device, gmax, gmin, gwire, gload, freq=10e6,
                 ...
                 enable_resistance_variance=False, resistance_variance_gamma=0. ,
                 enable_noise=True, enable_SAF=False, enable_val_SAF=True):
