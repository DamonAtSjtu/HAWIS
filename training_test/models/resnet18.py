...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        # HAWIS-A
        self.planes =[256, 256, 256, 256, 256, 448,448,448,448, 896,896,896,896, 1344,1344,1344,1344]
        # HAWIS-B
        ...
        self.conv1_1 = conv7x7_first(int(3*32), int(3*32), stride=2)
        self.bn1_1 = nn.BatchNorm2d(int(3*32))
        self.conv1_2 = conv3x3(int(3*32), self.inplanes, stride=2)
        self.conv1_2_r = conv1x1(int(3*32), self.inplanes, stride=1)
